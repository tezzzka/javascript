...
function showCategory(category) {
    //console.dir(products[category][0]);
...
function getProductMarkup(product) {
    console.log(product);
    return document.querySelector('.products').insertAdjacentHTML('afterbegin',`<div class="product"><div>${product.name}</div><img src="${product.imageUrl}" alt=""><div>${product.price}</div><a href="https://example.com/producs/${product.id}">Подробнее</a></div>`)
}
